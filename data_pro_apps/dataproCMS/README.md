...
![version](https://img.shields.io/badge/version-1.0.1-blue.svg) ![build](https://img.shields.io/badge/build-passing-brightgreen.svg)
...
1. Clone the repository
   ```bash
   git clone https://github.com/amatak-cloud/dataprocms.git
   cd dataprocms
   ```
...
| `build-worker` | Custom script |
| `worker:dev` | Custom script |
...
| fs | 0.0.1-security | — |
| react | 19.2.5 | A JavaScript library for building user interfaces |
| react-dom | 19.2.5 | — |
...
| eslint | 9.39.4 | Find and fix problems in your JavaScript code |
...
│   ├── 📄 App_1.jsx [.jsx] (169 lines)
│   ├── 📄 App_2.jsx [.jsx] (131 lines)
